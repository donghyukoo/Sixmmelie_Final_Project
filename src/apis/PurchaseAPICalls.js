...
export const callPurchaseListAPI = ({memberId}) => {
    const requestURL = `http://${process.env.REACT_APP_RESTAPI_IP}:8666/api/v1/purchase/${memberId}`;
...
export const callPurchaseAPI = ({form}) => {
    const requestURL = `http://${process.env.REACT_APP_RESTAPI_IP}:8666/api/v1/purchase`;
